...
{#if !hasMaptilerKey}
  <h2 class="text-red-500">
    Please set the PUBLIC_MAPTILER_KEY environment variable to your MapTiler API
    key to run this example.
  </h2>
{/if}

<p>
  This example uses a FillExtrusionLayer to show a 3D view of buildings, with
  shorter buildings in green and taller buildings in red.<br /> Hold down Ctrl and
  drag the mouse to rotate on a computer.
</p>
<MapLibre
  style={streetsStyle}
  class={mapClasses}
  standardControls
  center={[4.892709908365418, 52.3726598915369]}
  zoom={15.9}
  pitch={45}
  bearing={-17.6}
  filterLayers={(l) => {
